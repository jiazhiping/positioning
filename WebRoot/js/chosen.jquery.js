(function() {
	...
	AbstractChosen = (function() {
		...
		AbstractChosen.prototype.set_default_values = function() {
			...
			this.group_search = this.options.group_search != null ? this.options.group_search
					: true;
			this.search_contains = true;// this.options.search_contains ||
										// false;
		...
		AbstractChosen.default_no_result_text = "找不到数据：";
	...
	Chosen = (function(_super) {
		...
		Chosen.prototype.no_results = function(terms) {
			var no_results_html;
			no_results_html = $("<li class=\"no-results\"><span>"
					+ this.results_none_found + "\"" + terms + "\"</span></li>");
		...
		Chosen.prototype.keyup_arrow = function() {
			...
			if (!this.results_showing && !this.is_multiple) {
				...
				if (this.result_highlight) {
					prev_sibs = this.result_highlight
