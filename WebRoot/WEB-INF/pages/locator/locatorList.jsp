<%--
    User: Myk   Date: 2017/11/1    Time: 15:40
--%>
...
<body>
<div class="rightInfo">
    <form action="locator_locatorList.action" method="post" name="lForm" id="lForm">
        <div class="tools">
            <ul class="toolbar">
        ...
        <table class="tableList">
            ...
            <s:iterator value="locatorViews" status="st">
                <tr>
                    <td align="center">
                        <div class="radio i-checks">
                            <label> <input type="checkbox" value="${locatorId}" name="rdb"> </label>
                        </div>
                    </td>
                    ...
                    <td>
                        <s:if test="%{locatorState == 0}">未绑定</s:if>
                        <s:else>已绑定</s:else>
                    </td>
                    <td>
